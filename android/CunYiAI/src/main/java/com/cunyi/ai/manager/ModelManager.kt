...
class ModelManager(private val context: Context) {
    ...
    companion object {
        private var _staticInstance: ModelManager? = null
        fun init(context: Context) {
            _staticInstance = ModelManager(context.applicationContext)
        }
        fun getStaticInstance(): ModelManager? = _staticInstance
